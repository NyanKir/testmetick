<?php
$url='https://nyankir.github.io/testmetick';
$canonical=$url.'/';
$canonicalUA=$url.'/ua/';
...
foreach ($json as $person_name => $person_a) {
    ...
    mkdir("posts/".$person_a['folderName'], 0700);

    file_put_contents("posts/".$person_a['folderName']."/index.html", '<!DOCTYPE html >
                                                      ...
                                                      <div class="it-up-main-menu-wrap clearfix">
                                                          <nav class="it-up-main-navigation float-left ul-li">
                                                              <ul id="main-nav" class="navbar-nav text-capitalize clearfix">
                                                                <li><a class="nav-link" href="'.$canonical.'#it-up-banner">Главная</a></li>
                                                                   <li><a class="nav-link" href="'.$canonical.'#it-up-featured">Функционал</a></li>
                                                                   <li><a class="nav-link" href="'.$canonical.'#it-up-service">Цены</a></li>
                                                                   <li><a class="nav-link" href="'.$canonical.'#it-up-blog">Блог</a></li>
                                                                   <li><a class="nav-link" href="'.$canonical.'#it-up-contact">Контакты</a></li>
                                                              </ul>
                                                          </nav>
                                              ...
                                              <div class="container">
                                                  <div class="row" style="flex-direction: column">
                                                      <div class="blog_header">
                                                          ...
                                                          <img src="../../assets/'.$person_a["img"].'" alt="" class="blog-img">
                                                      <div class="blog_text">
                                                        '.$str.'
                                                      </div>
                                                  </div>
    ...
    mkdir("ua/posts/".$person_a['folderName'], 0700);

    file_put_contents("ua/posts/".$person_a['folderName']."/index.html", '<!DOCTYPE html >
                                          <html ⚡ lang="en" prefix="og: https://ogp.me/ns#">
                                          <head>
                                              <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
                                              ...
                                              <script async custom-element="amp-form" src="https://cdn.ampproject.org/v0/amp-form-0.1.js"></script>
                                              <style amp-boilerplate>body{-webkit-animation:-amp-start 8s steps(1,end) 0s 1 normal both;-moz-animation:-amp-start 8s steps(1,end) 0s 1 normal both;-ms-animation:-amp-start 8s steps(1,end) 0s 1 normal both;animation:-amp-start 8s steps(1,end) 0s 1 normal both}@-webkit-keyframes -amp-start{from{visibility:hidden}to{visibility:visible}}@-moz-keyframes -amp-start{from{visibility:hidden}to{visibility:visible}}@-ms-keyframes -amp-start{from{visibility:hidden}to{visibility:visible}}@-o-keyframes -amp-start{from{visibility:hidden}to{visibility:visible}}@keyframes -amp-start{from{visibility:hidden}to{visibility:visible}}</style><noscript><style amp-boilerplate>body{-webkit-animation:none;-moz-animation:none;-ms-animation:none;animation:none}</style></noscript>
                                              <link rel="canonical" href="'.$canonicalUA.'">
                                              ...
                                              <div class="it-up-header-main">
                                                  <div class="container">
                                                      ...
                                                      <div class="it-up-main-menu-wrap clearfix">
                                                          <nav class="it-up-main-navigation float-left ul-li">
                                                              <ul id="main-nav" class="navbar-nav text-capitalize clearfix">
                                                                  <li><a class="nav-link active" href="'.$canonicalUA.'#it-up-banner">Головна</a></li>
                                                                  <li><a class="nav-link" href="'.$canonicalUA.'#it-up-featured">Функціонал</a></li>
                                                                  <li><a class="nav-link" href="'.$canonicalUA.'#it-up-service">Ціни</a></li>
                                                                  <li><a class="nav-link" href="'.$canonicalUA.'#it-up-blog">Блог</a></li>
                                                                  <li><a class="nav-link" href="'.$canonicalUA.'#it-up-contact">Контакти</a></li>
                                                              </ul>
                                                          </nav>
                                                          <div class="it-up-header-cta-btn float-right text-center">
                                                              <a href="https://mediascan.cc/dashboard">Dashboard
                                          ...
                                          <section class=" position-relative blog-page" >
                                              <div class="container">
                                                  <div class="row" style="flex-direction: column">
                                                      <div class="blog_header">
                                                          <h3 class="blog-title">'.$person_a["titleUA"].'</h3>
                                                          <span class="blog-date">'.$person_a["date"].'</span>
                                                      </div>
                                                          <img src="../../../assets/'.$person_a["img"].'" alt="" class="blog-img">
                                                      <div class="blog_text">
                                          ...
                                          <script src="../../../scripts/typer-new.js"></script>
                                          <script src="//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js"></script>
                                          <script src="../../../scripts/initUA.js"></script>
                                          </body>
                                          </html>'
                          );
}
